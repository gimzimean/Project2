...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
	<!-- Brand Logo -->
	<a href="index.jsp" class="brand-link"> <img
	...
	<div class="sidebar">
		...
		<div class="user-panel mt-3 pb-3 mb-3 d-flex">
			...
			<div class="info">
				<c:choose>
					<c:when test="${not empty sessionScope.user }">
						<a href="#" class="d-block"><h1>${user.userName }</h1></a>
					</c:when>
					<c:otherwise>
						<a class="btn btn-warning text-dark d-flex align-items-center "
							href ="/user/login"><span>LOGIN</span></a>
			...
			<ul class="nav nav-pills nav-sidebar flex-column"
               ...
               with font-awesome or any other icon font library -->
					...
					<c:if test="${not empty sessionScope.user }">
						<li class="nav-item"><a href="*.band?cmd=write"
							class="nav-link"> <i class="nav-icon fas fa-plus-circle"></i>
								<p>Create</p>
						</a></li>
						<li class="nav-item"><a href="*.band?cmd=list"
							class="nav-link"> <i class="nav-icon fas fa-search"></i>
								<p>Search</p>
						</a></li>
						<li class="nav-item"><a
							href="*.band?cmd=tableList&userId=${user.userId }"
						...
						<li class="nav-item"><a href="*.band?cmd=calendar"
						...
						<li class="nav-item" style="height: 200px;"><a
							href="*.user?cmd=contactList" class="nav-link"> <i
								class="nav-icon fas fa-address-book"></i>
								<p>Contacts</p>
						</a></li>
						<a class="btn btn-warning text-dark "
							href="/user/logout"><span>LOGOUT</span></a>
